...
#   OUTLIERS INFERIORES
    if not df_roubo_veiculo_outliers_inferiores.empty:
        ...
        ax[0].barh(dados_inferiores['munic'], dados_inferiores['roubo_veiculo'], color='blue')
    else:
        ax[0].text(0.5, 0.5, 'Não há outliers inferiores', ha='center', va='center', fontsize=10)
...
#   OUTLIERS SUPERIORES
    if not df_roubo_veiculo_outliers_superiores.empty:
        ...
        ax[1].text(0.5, 0.5, 'Não há outliers superiores', ha='center', va='center', fontsize=10)
